...
from blog_mini.admin import admin
from blog_mini.models import ArticleType, Source, Article, article_types, \
    Comment, User, Follow, Menu, ArticleTypeSetting, BlogInfo, Plugin
from blog_mini.admin.forms import SubmitArticlesForm, ManageArticlesForm, DeleteArticleForm, \
...
def manage_articles():
    ...
    form = ManageArticlesForm(types = types_id,source = source_id)
    form2 = DeleteArticleForm()
    from3 = DeleteArticlesForm()
